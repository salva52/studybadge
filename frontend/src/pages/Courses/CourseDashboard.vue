<template>
	<div class="p-5">
		<div class="grid grid-cols-4 gap-5 mb-5 text-ink-gray-9">
			...
			/>
			<NumberChartGraph
				:title="__('Tasa Promedio de Finalización')"
				:value="averageCompletionRate"
			/>
			<NumberChartGraph
				:title="__('Calificación Promedio')"
			...
			<NumberChartGraph :title="__('Lecciones')" :value="course.data?.lessons" />
		</div>
		<div class="grid grid-cols-[2fr_1fr] gap-5 items-start">
			<div class="bg-white dark:bg-gray-800 shadow-sb-soft border border-gray-100 dark:border-gray-700 rounded-2xl py-5 px-6">
				<div class="flex items-center justify-between mb-5">
					<div class="text-xl text-ink-gray-9 font-bold">
						{{ __('Estudiantes') }}
					</div>
				...
				>
					...
					>
						<ListHeader
							class="mb-3 grid items-center gap-x-4 border-b border-gray-100 dark:border-gray-700 rounded-none pb-2 text-ink-gray-5 text-sm uppercase tracking-wider font-semibold"
						>
							<ListHeaderItem
								:item="item"
			...
			<div class="space-y-5">
				<div
					...
					class="bg-white dark:bg-gray-800 shadow-sb-soft border border-gray-100 dark:border-gray-700 rounded-2xl p-6"
				>
					<div class="text-ink-gray-5 text-sm uppercase tracking-wider font-semibold mb-4">
						{{ __('Resumen de Progreso') }}
					</div>
					<div
				...
				>
					<div class="flex items-center justify-between mb-4">
						<div class="text-ink-gray-5 text-sm uppercase tracking-wider font-semibold">
							{{ __('Finalización de Lecciones') }}
						</div>
						<Select
