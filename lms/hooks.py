...
app_icon_url = "/assets/lms/images/studybadge/studybadge-logo.png"
favicon = "/assets/lms/images/studybadge/studybadge-logo.png"
app_icon_title = "StudyBadge"
app_icon_route = "/lms"
app_color = "grey"
...
web_include_js = ["/assets/lms/js/referral.js"]
...
scheduler_events = {
	...
	"hourly": [
		...
		"lms.lms.subscriptions.process_plus_cancellations",
	],
	"daily": [
...
jinja = {
	"methods": [
		...
		"lms.lms.doctype.lms_certificate.lms_certificate.get_certificate_verification_url",
		"lms.lms.doctype.lms_certificate.lms_certificate.get_certificate_qr_svg",
	],
	"filters": [],
}
